...
|--------------------------|-------------|
| CAD_Designs/CAD_Designs  | Contains 3D models and mechanical design files for the robot chassis. |
| Main_Robot_Project       | Includes Arduino code, wiring diagrams, and main logic implementation. |
| Sensors_Datasheets       | Datasheets for IR and Ultrasonic sensors used in the project. |
